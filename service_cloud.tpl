						...
						{foreach $Service.list as $list}
							<tr>
								...
								<td>
									...
									<small class="text-muted">{$list.productname}</small><br>
								...
								<td>
                                    ...
                                    <span>
                                        CPU使用率：<span id="ogmiao-cpu-lable-{$list.id}">获取中</span>
                                        <div class="progress">
                                            <div id="ogmiao-cpu-progress-{$list.id}" class="progress-bar progress-bar-striped progress-bar-animated"></div>
                                        </div>
                                    </span>
                                    <span>
                                        内存使用率：<span id="ogmiao-mem-lable-{$list.id}">获取中</span>
                                        <div class="progress">
                                            <div id="ogmiao-mem-progress-{$list.id}" class="progress-bar progress-bar-striped progress-bar-animated"></div>
                                        </div>
                                    </span>
                                    <script>
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            if (cpuData = data.data.list[0]) {
                                              ...
                                              $("#ogmiao-cpu-progress-{$list.id}").css("width",cpuDataLatest + "%")
                                              $("#ogmiao-cpu-lable-{$list.id}").html(cpuDataLatest + "%")
                                              if (cpuDataLatest > 85) {
                                                $("#ogmiao-cpu-progress-{$list.id}").addClass('bg-danger')
                                              } else if (cpuDataLatest > 65) {
                                                $("#ogmiao-cpu-progress-{$list.id}").addClass('bg-warning')
                                              } else {
                                                $("#ogmiao-cpu-progress-{$list.id}").addClass('bg-success')
                                              }
                                            } else {
                                              $("#ogmiao-cpu-progress-{$list.id}").css("width","0%")
                                              $("#ogmiao-cpu-lable-{$list.id}").html("暂无数据，请稍后再试")
                                            }
                                            },
                                        error: function(data) {
                                            $("#ogmiao-cpu-progress-{$list.id}").css("width","0%")
                                    ...
                                    <script>
                                        ...
                                        success: function(data) {
                                            ...
                                            $("#ogmiao-mem-progress-{$list.id}").css("width",memDisplay + "%")
                                            $("#ogmiao-mem-lable-{$list.id}").html(memnowDataLatest + memUnit + " / " + memallDataLatest + memUnit + " (" + Math.round(memDisplay) + "%)")
                                            if (memDisplay > 75) {
                                                $("#ogmiao-mem-progress-{$list.id}").addClass('bg-danger')
                                            } else if (memDisplay > 60) {
                                                $("#ogmiao-mem-progress-{$list.id}").addClass('bg-warning')
                                            } else {
                                                $("#ogmiao-mem-progress-{$list.id}").addClass('bg-success')
                                            }
                                            $("#ogmiao-mem-progress-{$list.id}").removeClass('progress-bar')
                                            $("#ogmiao-mem-progress-{$list.id}").addClass('progress-determinate')
                                        },
                                        error: function(data) {
                                            $("#ogmiao-mem-progress-{$list.id}").css("width","0%")
                                            $("#ogmiao-mem-lable-{$list.id}").html("暂无数据，请稍后再试")
                                            $("#ogmiao-mem-progress-{$list.id}").removeClass('progress-bar')
                                            $("#ogmiao-mem-progress-{$list.id}").addClass('progress-determinate')
                                        }
                                        });
                                    ...
                                    {else}
                                    <span>
                                        CPU使用率：<span id="ogmiao-cpu-lable-{$list.id}">不能获取未激活的实例用量</span>
                                        <div class="progress">
                                            <div id="ogmiao-cpu-progress-{$list.id}" style="width: 0%;" class="progress-determinate"></div>
                                        </div>
                                    </span>
                                    <span>
                                        内存使用率：<span id="ogmiao-mem-lable-{$list.id}">不能获取未激活的实例用量</span>
                                        <div class="progress">
                                            <div id="ogmiao-mem-progress-{$list.id}" style="width: 0%;" class="progress-determinate"></div>
                                        </div>
                                    </span>
                                    {/if}
								</td>
