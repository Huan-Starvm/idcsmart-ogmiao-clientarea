    ...
    <div class="card-body">
        ...
        <div class="search-area">
            <div class="custom-search-container">
                <input type="text" class="custom-search-input" id="loginLogSearch" placeholder="搜索登录日志..." required>
...
$(document).ready(function() {
    ...
    // 自定义搜索功能
    $('#loginLogSearch').on('input', function() {
    ...
    $('#clearSearch').on('click', function() {
        $('#loginLogSearch').val('').trigger('input');
        $(this).css('opacity', '0');
    });
    
    // 添加搜索框动画效果
    $('#loginLogSearch').on('focus', function() {
